...
function SWEP:PrimaryAttack()
  ...
  if not self:IsTraceValid(tr) then
    return
  end
...
if CLIENT then
  ...
  function SWEP:RenderScreen()
    ...
    local toolgunRT = GetRenderTarget("GModToolgunScreen", 256, 256)
    Material("models/weapons/v_toolgun/screen"):SetTexture("$basetexture", toolgunRT)
